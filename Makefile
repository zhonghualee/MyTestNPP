#############################################################################
# Makefile for building: MyTestNPP
<<<<<<< HEAD
# Generated by qmake (2.01a) (Qt 4.7.4) on: ke 9. touko 12:18:00 2012
=======
# Generated by qmake (2.01a) (Qt 4.7.4) on: ma 7. touko 17:06:10 2012
...
c:\Work\MyTestNPP\MyTestNPP.loc: 
	$(QMAKE) "C:/Work/MyTestNPP/MyTestNPP.pro"  -spec ..\..\QtSDK\Symbian\SDKs\Symbian3Qt474\mkspecs\symbian-sbsv2 -after  OBJECTS_DIR=obj MOC_DIR=moc UI_DIR=ui RCC_DIR=rcc

debug: c:\Work\MyTestNPP\MyTestNPP.loc bld.inf
...
release: c:\Work\MyTestNPP\MyTestNPP.loc bld.inf
...
debug-winscw: c:\Work\MyTestNPP\MyTestNPP.loc bld.inf
...
debug-gcce: c:\Work\MyTestNPP\MyTestNPP.loc bld.inf
...
release-armv6-gcce4.4.1: c:\Work\MyTestNPP\MyTestNPP.loc bld.inf
...
run:
	call C:/QtSDK/Symbian/SDKs/Symbian3Qt474/epoc32/release/winscw/udeb/MyTestNPP.exe $(QT_RUN_OPTIONS)

runonphone: sis
	runonphone $(QT_RUN_ON_PHONE_OPTIONS) --sis MyTestNPP.sis MyTestNPP.exe $(QT_RUN_OPTIONS)

MyTestNPP_template.pkg: C:/Work/MyTestNPP/MyTestNPP.pro
	$(MAKE) -f $(MAKEFILE) qmake

MyTestNPP_installer.pkg: C:/Work/MyTestNPP/MyTestNPP.pro
	$(MAKE) -f $(MAKEFILE) qmake

MyTestNPP_stub.pkg: C:/Work/MyTestNPP/MyTestNPP.pro
	$(MAKE) -f $(MAKEFILE) qmake

sis: MyTestNPP_template.pkg
...
ok_sis:
	C:\QtSDK\Symbian\SDKs\Symbian3Qt474\bin\createpackage.bat -g $(QT_SIS_OPTIONS) MyTestNPP_template.pkg $(QT_SIS_TARGET) $(QT_SIS_CERTIFICATE) $(QT_SIS_KEY) $(QT_SIS_PASSPHRASE)

unsigned_sis: MyTestNPP_template.pkg
...
ok_unsigned_sis:
	C:\QtSDK\Symbian\SDKs\Symbian3Qt474\bin\createpackage.bat -g $(QT_SIS_OPTIONS) -o MyTestNPP_template.pkg $(QT_SIS_TARGET)

MyTestNPP.sis:
	$(MAKE) -f $(MAKEFILE) sis

installer_sis: MyTestNPP_installer.pkg sis
	$(MAKE) -f $(MAKEFILE) ok_installer_sis

ok_installer_sis: MyTestNPP_installer.pkg
	C:\QtSDK\Symbian\SDKs\Symbian3Qt474\bin\createpackage.bat $(QT_SIS_OPTIONS) MyTestNPP_installer.pkg - $(QT_SIS_CERTIFICATE) $(QT_SIS_KEY) $(QT_SIS_PASSPHRASE)

unsigned_installer_sis: MyTestNPP_installer.pkg unsigned_sis
	$(MAKE) -f $(MAKEFILE) ok_unsigned_installer_sis

ok_unsigned_installer_sis: MyTestNPP_installer.pkg
	C:\QtSDK\Symbian\SDKs\Symbian3Qt474\bin\createpackage.bat $(QT_SIS_OPTIONS) -o MyTestNPP_installer.pkg

fail_sis_nocache:
	$(error Project has to be built or QT_SIS_TARGET environment variable has to be set before calling 'SIS' target)

stub_sis: MyTestNPP_stub.pkg
...
ok_stub_sis:
	C:\QtSDK\Symbian\SDKs\Symbian3Qt474\bin\createpackage.bat -s $(QT_SIS_OPTIONS) MyTestNPP_stub.pkg $(QT_SIS_TARGET) $(QT_SIS_CERTIFICATE) $(QT_SIS_KEY) $(QT_SIS_PASSPHRASE)
...
dodistclean:
	-@ if EXIST "c:\Work\MyTestNPP\MyTestNPP_template.pkg" $(DEL_FILE)  "c:\Work\MyTestNPP\MyTestNPP_template.pkg"
	-@ if EXIST "c:\Work\MyTestNPP\MyTestNPP_stub.pkg" $(DEL_FILE)  "c:\Work\MyTestNPP\MyTestNPP_stub.pkg"
	-@ if EXIST "c:\Work\MyTestNPP\MyTestNPP_installer.pkg" $(DEL_FILE)  "c:\Work\MyTestNPP\MyTestNPP_installer.pkg"
	-@ if EXIST "c:\Work\MyTestNPP\Makefile" $(DEL_FILE)  "c:\Work\MyTestNPP\Makefile"
	-@ if EXIST "c:\Work\MyTestNPP\MyTestNPP_exe.mmp" $(DEL_FILE)  "c:\Work\MyTestNPP\MyTestNPP_exe.mmp"
	-@ if EXIST "c:\Work\MyTestNPP\MyTestNPP_reg.rss" $(DEL_FILE)  "c:\Work\MyTestNPP\MyTestNPP_reg.rss"
	-@ if EXIST "c:\Work\MyTestNPP\MyTestNPP.rss" $(DEL_FILE)  "c:\Work\MyTestNPP\MyTestNPP.rss"
	-@ if EXIST "c:\Work\MyTestNPP\MyTestNPP.loc" $(DEL_FILE)  "c:\Work\MyTestNPP\MyTestNPP.loc"
