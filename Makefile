#############################################################################
# Makefile for building: basicTestNPP
# Generated by qmake (2.01a) (Qt 4.7.4) on: to 10. touko 12:13:53 2012
# Project:  MyTestNPP.pro
# Template: app
# Command: c:\qtsdk\symbian\sdks\symbian3qt474\bin\qmake.exe -spec ..\..\QtSDK\Symbian\SDKs\Symbian3Qt474\mkspecs\symbian-sbsv2 -after  OBJECTS_DIR=obj MOC_DIR=moc UI_DIR=ui RCC_DIR=rcc -o bld.inf MyTestNPP.pro
#############################################################################
...
qmake:
	$(QMAKE) "C:/Work/MyTestNPP/MyTestNPP.pro"  -spec ..\..\QtSDK\Symbian\SDKs\Symbian3Qt474\mkspecs\symbian-sbsv2 -after  OBJECTS_DIR=obj MOC_DIR=moc UI_DIR=ui RCC_DIR=rcc

bld.inf: C:/Work/MyTestNPP/MyTestNPP.pro
	$(QMAKE) "C:/Work/MyTestNPP/MyTestNPP.pro"  -spec ..\..\QtSDK\Symbian\SDKs\Symbian3Qt474\mkspecs\symbian-sbsv2 -after  OBJECTS_DIR=obj MOC_DIR=moc UI_DIR=ui RCC_DIR=rcc

c:\Work\MyTestNPP\basicTestNPP.loc: 
	$(QMAKE) "C:/Work/MyTestNPP/MyTestNPP.pro"  -spec ..\..\QtSDK\Symbian\SDKs\Symbian3Qt474\mkspecs\symbian-sbsv2 -after  OBJECTS_DIR=obj MOC_DIR=moc UI_DIR=ui RCC_DIR=rcc

debug: c:\Work\MyTestNPP\basicTestNPP.loc bld.inf
...
release: c:\Work\MyTestNPP\basicTestNPP.loc bld.inf
...
debug-winscw: c:\Work\MyTestNPP\basicTestNPP.loc bld.inf
...
debug-gcce: c:\Work\MyTestNPP\basicTestNPP.loc bld.inf
...
release-armv6-gcce4.4.1: c:\Work\MyTestNPP\basicTestNPP.loc bld.inf
...
run:
	call C:/QtSDK/Symbian/SDKs/Symbian3Qt474/epoc32/release/winscw/udeb/basicTestNPP.exe $(QT_RUN_OPTIONS)

runonphone: sis
	runonphone $(QT_RUN_ON_PHONE_OPTIONS) --sis basicTestNPP.sis basicTestNPP.exe $(QT_RUN_OPTIONS)

basicTestNPP_template.pkg: C:/Work/MyTestNPP/MyTestNPP.pro
	$(MAKE) -f $(MAKEFILE) qmake

basicTestNPP_installer.pkg: C:/Work/MyTestNPP/MyTestNPP.pro
	$(MAKE) -f $(MAKEFILE) qmake

basicTestNPP_stub.pkg: C:/Work/MyTestNPP/MyTestNPP.pro
	$(MAKE) -f $(MAKEFILE) qmake

sis: basicTestNPP_template.pkg
...
ok_sis:
	C:\QtSDK\Symbian\SDKs\Symbian3Qt474\bin\createpackage.bat -g $(QT_SIS_OPTIONS) basicTestNPP_template.pkg $(QT_SIS_TARGET) $(QT_SIS_CERTIFICATE) $(QT_SIS_KEY) $(QT_SIS_PASSPHRASE)

unsigned_sis: basicTestNPP_template.pkg
...
ok_unsigned_sis:
	C:\QtSDK\Symbian\SDKs\Symbian3Qt474\bin\createpackage.bat -g $(QT_SIS_OPTIONS) -o basicTestNPP_template.pkg $(QT_SIS_TARGET)

basicTestNPP.sis:
	$(MAKE) -f $(MAKEFILE) sis

installer_sis: basicTestNPP_installer.pkg sis
	$(MAKE) -f $(MAKEFILE) ok_installer_sis

ok_installer_sis: basicTestNPP_installer.pkg
	C:\QtSDK\Symbian\SDKs\Symbian3Qt474\bin\createpackage.bat $(QT_SIS_OPTIONS) basicTestNPP_installer.pkg - $(QT_SIS_CERTIFICATE) $(QT_SIS_KEY) $(QT_SIS_PASSPHRASE)

unsigned_installer_sis: basicTestNPP_installer.pkg unsigned_sis
	$(MAKE) -f $(MAKEFILE) ok_unsigned_installer_sis

ok_unsigned_installer_sis: basicTestNPP_installer.pkg
	C:\QtSDK\Symbian\SDKs\Symbian3Qt474\bin\createpackage.bat $(QT_SIS_OPTIONS) -o basicTestNPP_installer.pkg

fail_sis_nocache:
	$(error Project has to be built or QT_SIS_TARGET environment variable has to be set before calling 'SIS' target)

stub_sis: basicTestNPP_stub.pkg
...
ok_stub_sis:
	C:\QtSDK\Symbian\SDKs\Symbian3Qt474\bin\createpackage.bat -s $(QT_SIS_OPTIONS) basicTestNPP_stub.pkg $(QT_SIS_TARGET) $(QT_SIS_CERTIFICATE) $(QT_SIS_KEY) $(QT_SIS_PASSPHRASE)

deploy: sis
	call basicTestNPP.sis
...
moc\moc_mainwindow.cpp: PayApi.h \
		MStateHandler.h \
		mainwindow.h
	C:\QtSDK\Symbian\SDKs\Symbian3Qt474\bin\moc.exe $(DEFINES) $(INCPATH) -DSYMBIAN c:\Work\MyTestNPP\mainwindow.h -o c:\Work\MyTestNPP\moc\moc_mainwindow.cpp

compiler_rcc_make_all: rcc\qrc_MyTestNPP.cpp
compiler_rcc_clean:
	-$(DEL_FILE) rcc\qrc_MyTestNPP.cpp
rcc\qrc_MyTestNPP.cpp: MyTestNPP.qrc \
		paid.png
	c:\QtSDK\Symbian\SDKs\Symbian3Qt474\bin\rcc.exe -name MyTestNPP c:\Work\MyTestNPP\MyTestNPP.qrc -o c:\Work\MyTestNPP\rcc\qrc_MyTestNPP.cpp
...
ui\ui_mainwindow.h: mainwindow.ui
	c:\QtSDK\Symbian\SDKs\Symbian3Qt474\bin\uic.exe c:\Work\MyTestNPP\mainwindow.ui -o c:\Work\MyTestNPP\ui\ui_mainwindow.h
...
dodistclean:
	-@ if EXIST "c:\Work\MyTestNPP\basicTestNPP_template.pkg" $(DEL_FILE)  "c:\Work\MyTestNPP\basicTestNPP_template.pkg"
	-@ if EXIST "c:\Work\MyTestNPP\basicTestNPP_stub.pkg" $(DEL_FILE)  "c:\Work\MyTestNPP\basicTestNPP_stub.pkg"
	-@ if EXIST "c:\Work\MyTestNPP\basicTestNPP_installer.pkg" $(DEL_FILE)  "c:\Work\MyTestNPP\basicTestNPP_installer.pkg"
	-@ if EXIST "c:\Work\MyTestNPP\Makefile" $(DEL_FILE)  "c:\Work\MyTestNPP\Makefile"
	-@ if EXIST "c:\Work\MyTestNPP\basicTestNPP_exe.mmp" $(DEL_FILE)  "c:\Work\MyTestNPP\basicTestNPP_exe.mmp"
	-@ if EXIST "c:\Work\MyTestNPP\basicTestNPP_reg.rss" $(DEL_FILE)  "c:\Work\MyTestNPP\basicTestNPP_reg.rss"
	-@ if EXIST "c:\Work\MyTestNPP\basicTestNPP.rss" $(DEL_FILE)  "c:\Work\MyTestNPP\basicTestNPP.rss"
	-@ if EXIST "c:\Work\MyTestNPP\basicTestNPP.loc" $(DEL_FILE)  "c:\Work\MyTestNPP\basicTestNPP.loc"
	-@ if EXIST "c:\Work\MyTestNPP\bld.inf" $(DEL_FILE)  "c:\Work\MyTestNPP\bld.inf"
